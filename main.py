...
import sys
from PyQt5.QtWidgets import QApplication, QWidget # 애플리케이션 핸들러와 빈 GUI 위젯제
...
class Calculator(QWidget): # QWidget 클래스를 상속받아서 클래스를 정의
    ...
    def initUI(self):
        ...
        self.resize(256, 256) # 사이즈
        self.show() # 화면이 표시되도록 호출
...
if __name__ == '__main__': # pyqt는 애플리케이션 당 1개의 QApplication이 필요함
    ...
    sys.exit(app.exec_()) # 애플리케이션 이벤트 처리를 하도록 루프 구동
